#!/usr/bin/env python3
"""
Quantization script specifically for Qwen2.5-VL models.
"""
...
def setup_logging():
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('quantization_qwen_vl.log')
        ]
    )
...
def main():
    ...
    try:
        ...
        configs_to_try = [
            ...
            {"nbits": 8, "group_size": 128, "tiling_mode": "1D", "method": "sinq"},  # Try 8-bit as fallback
        ]
